    ...
    public sealed class OpenAIClient
    {
        ...
        public string Chat(string systemPrompt, string userPrompt)
        {
            ...
            catch (WebException ex)
            {
                ...
                throw new Exception("OPENAI API ERROR" + Environment.NewLine + "Endpoint: " + AppConfig.OpenAIUrl + Environment.NewLine + "Model: " + AppConfig.OpenAIModel + Environment.NewLine + "Details: " + details, ex);
            }
        }
        ...
        private string ExtractOutputText(string responseText)
        {
            ...
            if (root.ContainsKey("error") && root["error"] != null) throw new Exception("OpenAI returned an error: " + responseText);
