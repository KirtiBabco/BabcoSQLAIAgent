...
<head runat="server">
    ...
    <style>
        *{box-sizing:border-box}body{margin:0;font-family:Segoe UI,Arial,sans-serif;background:linear-gradient(145deg,#eef2ff,#f8fafc 48%,#ecfeff);color:#172033;min-height:100vh}
        ...
        .login{display:flex;align-items:center;justify-content:center;padding:40px}.card{width:min(470px,100%);background:#fff;padding:34px;border-radius:20px;box-shadow:0 20px 70px rgba(30,41,59,.16);border:1px solid #e2e8f0}.eyebrow{font-size:12px;color:#2563eb;font-weight:800;letter-spacing:.12em;text-transform:uppercase}.card h2{font-size:28px;margin:9px 0 8px}.muted{color:#64748b;line-height:1.55;margin:0 0 24px}.btn{width:100%;border:0;border-radius:11px;padding:13px 16px;font-size:15px;font-weight:700;cursor:pointer}.entra{background:#2563eb;color:#fff}.test{background:#eef2ff;color:#3730a3;margin-top:10px}.btn:disabled{opacity:.5;cursor:not-allowed}.sep{display:flex;align-items:center;gap:12px;color:#94a3b8;font-size:12px;margin:20px 0}.sep:before,.sep:after{content:"";height:1px;background:#e2e8f0;flex:1}.msg{display:block;width:100%;margin-top:16px;padding:12px;border-radius:10px;background:#fff7ed;border:1px solid #fed7aa;color:#9a3412;white-space:pre-wrap;font-size:13px;line-height:1.45;overflow-wrap:anywhere}.status{display:block;width:100%;margin-top:18px;padding:12px;border-radius:10px;background:#f8fafc;border:1px solid #e2e8f0;font-size:12px;color:#475569;line-height:1.55;overflow-wrap:anywhere}.configLine{color:#64748b;font-size:11px}.secure{display:flex;gap:8px;align-items:center;margin-top:18px;color:#64748b;font-size:12px}
    ...
    <section class="login">
        <div class="card">
            ...
            <asp:Panel ID="pnlLocalTest" runat="server">
                <div class="sep">LOCAL TESTING</div>
                <asp:Button ID="btnLocalTest" runat="server" Text="Local Test Admin Login" CssClass="btn test" OnClick="btnLocalTest_Click" />
            </asp:Panel>
